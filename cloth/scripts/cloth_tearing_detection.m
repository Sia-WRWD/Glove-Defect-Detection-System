function cloth_tearing = cloth_tearing_detection(img)

% img = imread('../dataset/tearing/tearing_3.jpg');
E = entropyfilt(img);
Eimg = rescale(E);
...
for i = 1:numOpenSeam
    ...
    textString = sprintf('Tearing %d', i); % Customize the text string as needed
